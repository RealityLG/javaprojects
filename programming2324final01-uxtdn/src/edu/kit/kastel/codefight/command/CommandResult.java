...
/**
 * This class represents the result of an edu.kit.kastel.codefight.command. It contains a message and a type. The type indicates whether the
 * edu.kit.kastel.codefight.command was successful or not. The message contains additional information about the result.
 * 
